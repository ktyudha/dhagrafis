  ...
  <footer class="footer footer-center text-base-content rounded p-10 gap-y-7" id="footer">
    <nav class="grid grid-flow-col lg:gap-4 gap-2">
      ...
      <RouterLink to="/contact" class="link link-hover font-bold tracking-widest"
        >Contact</RouterLink
      >
      <RouterLink to="/jobs" class="link link-hover font-bold tracking-widest">Jobs</RouterLink>
      <RouterLink to="/katalog" class="link link-hover font-bold tracking-widest"
        >Katalog</RouterLink
      >
      <RouterLink to="/promo" class="link link-hover font-bold tracking-widest">Promo</RouterLink>
    </nav>
    <nav>
    ...
    <aside>
      <p class="tracking-wider text-xs">
        Copyright {{ new Date().getFullYear() }} Dhagrafis | All right reserved.
      </p>
    </aside>
  </footer>
</template>
