      ...
      h('div', { class: 'flex gap-2' }, [
        h(
          'button',
          {
            ...
            onClick: () => router.push('/dashboard/articles/' + info.row.original.slug)
          },
        ...
        h(
          'button',
          {
            ...
            onClick: () => {
              router.push(`/dashboard/articles/${info.row.original.slug}/edit`)
            }
          },
        ...
        h(
          'button',
          {
            ...
            onClick: () => emit('destroy', info.row.original.slug)
          },
